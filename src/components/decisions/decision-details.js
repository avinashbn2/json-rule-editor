...
component to View/Update/Delete the expressions/yields/note on expansion of View Details 
...
class DecisionDetails extends Component {
  ...
  onChangeYield(e, name) {
    ...
    if (name == "weight") {
      if (isNaN(e.target.value)) {
        ...
        // check for weight beyond 7 decimal places
  ...
  renderConditions = (_, index) => {
    ...
    const { expressions = [], yields = [], note = "", override } = rulecases[
      index
    ];
    ...
    const getOperators = (eName) => {
      ...
      const opertorOptions =
        attribute && operator[attribute.fieldType || attribute.type];
        ...
        <div className="decision-box" key={`case - `}>
                  ...
                  <div style={{ display: "flex", alignItems: "center" }}>
                    ...
                    >
                      <a
                        href=""
                        onClick={(e) =>
                          this.editCondition(e, -1, index, "note")
                        }
                      >
          ...
          <div className="add-field-panel">
            {expressions.map((expression, idx) => (
              ...
              >
                ...
                this.state.currentEditType === "expression" ? (
                  <>
                    <div
                      className="field"
                      key={`field${expression.name}${expression.value}`}
                    >
                      <SelectField
                    ...
                    <div>
                      {this.renderValueField({ expression, hideLabel: true })}
                    </div>
                    <div>
                      <Checkbox
                    ...
                    <div>
                      {expression.value.includes(",") ? (
                        <SelectField
                          options={
                            FieldOptions[
                              currentExpression.name || expression.name
                            ]
                          }
                          onChange={(e) => this.onChangeField(e, "value")}
                          value={expression.value}
                ...
                <div
                  className="tool-flex"
                  key={`tool-flex${expression.name}${expression.value}`}
                >
                  <div>
                    ...
                    <a
                      href=""
                      onClick={(e) =>
                        this.editCondition(e, idx, index, "expression")
                      }
                    >
                      <span className="fa fa-edit" />
                    </a>
                  ...
                  <div>
                    <a
                      href=""
                      onClick={(e) =>
                        this.handleRemoveCondition(e, idx, index, "expression")
                      }
                    >
          ...
          <div className="add-field-panel">
            {yields.map((yld, idx) => (
              ...
              >
                {currentEditIndex === idx &&
                this.state.currentEditType === "yield" ? (
                  <>
                    <div>
                      <SelectField
                    ...
                    <div>
                      <InputField
                        onChange={(value) =>
                          this.onChangeYield(value, "weight")
                        }
                        value={yld.weight}
                        label={null}
                ...
                <div className="tool-flex">
                    ...
                    {currentEditIndex !== idx &&
                      this.state.currentEditType !== "yield" && (
                        <a
                          href=""
                          onClick={(e) =>
                            this.editCondition(e, idx, index, "yield")
                          }
                        >
                          <span className="fa fa-edit" />
                        </a>
                  ...
                  <div>
                    <a
                      href=""
                      onClick={(e) =>
                        this.handleRemoveCondition(e, idx, index, "yield")
                      }
                    >
                      <span className="fa fa-trash-o" />
                    </a>
  ...
  render() {
    ...
    const rulecases = rulecasesWithoutIndex.map((rulecase, index) => ({
      ...rulecase,
      index,
    }));
      ...
      .map(({ expressions, note, index }) => (
        <div key={note}>
          <PanelBox className={"boolean"} key={`PanelBox-${note}`}>
            ...
            <div className="type">
              conditions{" "}
              <span className="type-badge">{expressions.length}</span>
            </div>
            <div className="menu">
              ...
              <a
                href=""
                onClick={(e) =>
                  this.handleRemoveConditions(e, /*String(note)*/ index)
                }
              >
                Remove
              </a>
